        ...
        ">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                ...
                ">
                    ...
                    <div style="font-size: 12px; opacity: 0.8;"> 하면 으로 한  </div>
                </button>
                ...
                ">
                    ...
                    <div style="font-size: 12px; opacity: 0.9;">  를  하여   </div>
                </button>
            </div>
        ...
        ">
            ...
            <div style="display: flex; gap: 10px; justify-content: center;">
                <button onclick="this.parentElement.parentElement.parentElement.remove()" style="
                    ...
                    font-weight: bold;
                "></button>
                <button onclick="this.parentElement.parentElement.parentElement.remove(); alert('는 AI   를 해주세요.');" style="
                    background: #667eea;
                    color: white;
                    border: none;
                    padding: 12px 24px;
...
console.log('[ 화]    - https://manwon-generator.onrender.com/    ');