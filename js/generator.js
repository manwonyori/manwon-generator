...
async function generateHeritageStory(productName) {
    ...
    if (window.currentProductAnalysis) {
        ...
        -  : ${analysis.contentStrategy ? analysis.contentStrategy.keywords.join(', ') : ', '}
...
async function generateTrustContent(productName) {
    if (!productName) {
        return `<p><span class="highlight">"   !"</span></p>
    <p>     .    ,   .</p>`;
    }
    ...
    return `<p><span class="highlight">"${productName},   !"</span></p>
    <p>     .       .</p>`;
}
...
async function generateFAQ(productName) {
    ...
    return `<div class="faq-item">
        <div class="faq-question">Q. ${productName}   ?</div>
        <div class="faq-answer">A. ,       .</div>
    </div>
    <div class="faq-item">
        <div class="faq-question">Q.   ?</div>
...
function generateHeritageTimeline() {
    ...
    <div class="timeline-container">
        <div class="timeline-item">
            ...
            <div class="timeline-content">    마서  </div>
        </div>
        <div class="timeline-item">
...
function generateImpactContent(productName) {
    return `<p class="heritage-quote">"130      ${productName}"</p>
    <p> 3     (Jabugo)    .
                 .</p>`;
}
